...
export default function About() {
  ...
  const values = [
    {
      name: t(messages, 'about.values.quality.title'),
      description: t(messages, 'about.values.quality.description'),
      icon: StarIcon,
    },
    {
      name: t(messages, 'about.values.safety.title'),
      description: t(messages, 'about.values.safety.description'),
